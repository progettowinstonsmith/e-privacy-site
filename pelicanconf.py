...
EVENT_PATH = 'content/2026/autumn/'
YEAR = '2026'
EDITION = 'autumn'
...
PARTNERS = {'whistleblowingsolutions': ('Whistleblowing Solutions',
                             'whistleblowingsolutionslogo_206x165.png',
                             'https://www.whistleblowingsolutions.it/'),
 'APHIM': ('Associazione Privacy and Information Healthcare Manager', 'aphim.gif', 'http://www.apihm.it/'),
 'upmansan': ('Master in Management delle Aziende Sanitarie dell’Università di Pisa',
              'mansan.jpg',
 ...
 'aipsi': ('A.I.P.S.I. - Associazione Italiana Professionisti Sicurezza Informatica',
           'aipsi.png',
           'http://www.aipsi.org'),
 'albast': ('Alba S.T. s.r.l', 'albast.png', 'http://ww.alba.st'),
 'amadir': ('AMADIR', 'amadir.jpg', 'http://www.amadir.it'),
 'ask': ('ASK dell’Università Bocconi di Milano',
         'ask.png',
         'http://www.ask.unibocconi.it/wps/wcm/connect/Cdr/Centro_ASK/Home'),
 'asr': ('Associazione Stampa Romana',
         'asr.jpg',
         'https://www.facebook.com/pages/Associazione-Stampa-Romana/181737418510039/'),
 ...
 'hermes': ('Centro Studi Hermes per la Trasparenza e i Diritti Civili Digitali',
            'hermes.png',
            'http://hermescenter.org'),
 'fiif': ("Fondazione Italiana per l'Innovazione Forense", 'fiif.png', 'http://fiif.it'),
 'firenze': ('Comune di Firenze',
             'comune-firenze.png',
             'http://www.comune.fi.it/opencms/export/sites/retecivica/comune_firenze/comune/consiglio/gruppi_consiliari.htm'),
 'firenze1': ('Comune di Firenze: Consiglio di Quartiere 1',
              'logoq1.gif',
              'http://www.comune.fi.it/opencms/export/sites/retecivica/comune_firenze/comune/consiglio/gruppi_consiliari.htm'),
 ...
 'luording': ('Ordine degli Ingegneri della Provincia di Lucca',
              'lu-ording.jpg',
              'http://www.ordineingegneri.lucca.it/'),
 ...
 'scpol': ('Facoltà di Scienze Politiche - Università degli Studi di Firenze',
           'unifi.jpg',
           'http://www.scpol.unifi.it'),
 'secure_network': ('Secure Network S.r.l.', 'secure_network.png', 'http://www.securenetwork.it'),
 'segment': ('Segment is an Italian company involved in IT security and ethical hacking',
             'segment.png',
 ...
 'unica': ('Università degli Studi di Cagliari - Facolta’ di Scienze Economiche, Giuridiche e Politiche',
           'unica.jpg',
           'http://www.unica.it/pub/7/show.jsp?id=20415&amp;iso=-2&amp;is=7'),
 'unimifsd': ('Università di Milano - Dipartimento di scienze giuridiche "Cesare Beccaria" - Sezione di Filosofia e '
              'Sociologia del Diritto',
              'unimifsd.jpg',
              'http://users.unimi.it/beccaria/index.php/dipartimento/filosofia-e-sociologia-del-diritto'),
 ...
 'roma3': ('Università Roma Tre - Dipartimento di Giurisprudenza',
           'LogoDipartimentoGiurisprudenza.jpg',
           'https://www.uniroma3.it/ateneo/dipartimenti-e-scuole/dipartimenti/giurisprudenza-009447/'),
 ...
 'federazionetoscana': ('Federazione Regionale Ingegneri Toscana',
                        'federazione_regionale_ingegneri.png',
                        'http://www.federazioneingegneri.toscana.it/'),
...
SUBMIT_SETTINGS = {'STATIC_RECIPIENTS': ['segreteria@winstonsmith.org', 'exedre@winstonsmith.org', 'marcoc@marcoc.it'],
...
SLIDES_SETTINGS = {'STATIC_RECIPIENTS': ['segreteria@winstonsmith.org'],
 'SENDER_EMAIL': 'segreteria@winstonsmith.org',
...
ALL_EDIZIONI = [(2002,
 ...
 (2025,
  {'spring': {'city': 'Bari',
              ...
              'edition': 'XXXVI',
              'location': 'Università degli Studi di Bari - Dipartimento di Giurisprudenza, Piazza Cesare Battisti, 1, '
                          '70122 Bari BA',
...
EXTRA_PATH_METADATA = {
    ...
    'extra/cgi-bin/submit-slides.py': {'path': 'cgi-bin/submit-slides.py'},
